...
public class Device {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the device.")
  public String getId() {
    return id;
  }
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The timestamp of the device's creation in seconds since Jan 01 1970 (UTC). ")
   ...
   * @return updatedAt
  **/
  @ApiModelProperty(value = "The timestamp of the device's creation in seconds since Jan 01 1970 (UTC). ")
  public Long getUpdatedAt() {
    return updatedAt;
  }

  public Device group(List<String> group) {
    this.group = group;
    return this;
  }

  public Device addGroupItem(String groupItem) {
    if (this.group == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, updatedAt, group, name, deviceType);
  }
