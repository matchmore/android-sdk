 ...
 */
@ApiModel(description = "A pin device is one that has geographical location associated with it but is not represented by any object in the physical world. ")

public class PinDevice extends Device {
  @SerializedName("location")
  private Location location = null;

  public PinDevice location(Location location) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PinDevice pinDevice = (PinDevice) o;
    return Objects.equals(this.location, pinDevice.location) &&
        super.equals(o);
  }
