...
public class Publication {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the publication.")
  public String getId() {
    return id;
  }
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The timestamp of the publication creation in seconds since Jan 01 1970 (UTC). ")
  public Long getCreatedAt() {
    return createdAt;
  }

  public Publication worldId(String worldId) {
   ...
   * @return worldId
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the world that contains device to attach a publication to.")
  ...
  public Publication deviceId(String deviceId) {
   ...
   * @return deviceId
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the device to attach a publication to.")
  ...
  public Publication topic(String topic) {
    this.topic = topic;
    return this;
  }
   ...
   * @return topic
  **/
  @ApiModelProperty(required = true, value = "The topic of the publication. This will act as a first match filter. For a subscription to be able to match a publication they must have the exact same topic. ")
  ...
  public Publication range(Double range) {
    this.range = range;
    return this;
  }
   ...
   * @return range
  **/
  @ApiModelProperty(required = true, value = "The range of the publication in meters. This is the range around the device holding the publication in which matches with subscriptions can be triggered. ")
  ...
  public Publication duration(Double duration) {
   ...
   * @return duration
  **/
  @ApiModelProperty(required = true, value = "The duration of the publication in seconds. If set to '-1' the publication will live forever and if set to '0' it will be instant at the time of publication. ")
  ...
  public Publication properties(Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public Publication putPropertiesItem(String key, String propertiesItem) {
   ...
   * @return properties
  **/
  @ApiModelProperty(required = true, value = "The dictionary of key, value pairs.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, publication.id) &&
        ...
        Objects.equals(this.worldId, publication.worldId) &&
        Objects.equals(this.deviceId, publication.deviceId) &&
        Objects.equals(this.topic, publication.topic) &&
        Objects.equals(this.range, publication.range) &&
        Objects.equals(this.duration, publication.duration) &&
        Objects.equals(this.properties, publication.properties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, worldId, deviceId, topic, range, duration, properties);
  }
