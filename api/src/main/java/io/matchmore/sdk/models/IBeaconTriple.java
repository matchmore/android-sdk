...
public class IBeaconTriple {
  ...
  public IBeaconTriple deviceId(String deviceId) {
   ...
   * @return deviceId
  **/
  @ApiModelProperty(value = "The deviceId of the beacon. ")
  ...
  public IBeaconTriple proximityUUID(String proximityUUID) {
  ...
  **/
  @ApiModelProperty(value = "The UUID of the beacon, the purpose is to distinguish iBeacons in your network, from all other beacons in networks outside your control. ")
  ...
  public IBeaconTriple major(Integer major) {
    this.major = major;
    return this;
  }
   ...
   * @return major
  **/
  @ApiModelProperty(value = "Major values are intended to identify and distinguish a group. ")
  ...
  public IBeaconTriple minor(Integer minor) {
    this.minor = minor;
    return this;
  }
   ...
   * @return minor
  **/
  @ApiModelProperty(value = "Minor values are intended to identify and distinguish an individual. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IBeaconTriple ibeaconTriple = (IBeaconTriple) o;
    return Objects.equals(this.deviceId, ibeaconTriple.deviceId) &&
        Objects.equals(this.proximityUUID, ibeaconTriple.proximityUUID) &&
        Objects.equals(this.major, ibeaconTriple.major) &&
        Objects.equals(this.minor, ibeaconTriple.minor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceId, proximityUUID, major, minor);
  }
