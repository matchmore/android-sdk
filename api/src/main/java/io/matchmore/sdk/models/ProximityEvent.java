 ...
 */
@ApiModel(description = "A proximity event is triggered to the core when a mobile device detects an iBeacon device in his Bluetooth Low Energy(BLE) range. ")
...
public class ProximityEvent {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the proximity event.")
  public String getId() {
    return id;
  }
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The timestamp of the proximity event in seconds since Jan 01 1970 (UTC). ")
  public Long getCreatedAt() {
    return createdAt;
  }

  public ProximityEvent deviceId(String deviceId) {
   ...
   * @return deviceId
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the iBeacon to trigger a proximity event to.")
  ...
  public ProximityEvent distance(Double distance) {
   ...
   * @return distance
  **/
  @ApiModelProperty(required = true, value = "Distance between the mobile device that trigger the proximity event and the ranged iBeacon. This distance is automatically generated by the SDK based upon the CLProximity. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProximityEvent proximityEvent = (ProximityEvent) o;
    return Objects.equals(this.id, proximityEvent.id) &&
        Objects.equals(this.createdAt, proximityEvent.createdAt) &&
        Objects.equals(this.deviceId, proximityEvent.deviceId) &&
        Objects.equals(this.distance, proximityEvent.distance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, deviceId, distance);
  }
