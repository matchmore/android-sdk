...
import io.matchmore.sdk.models.DeviceType;
 ...
 */
@ApiModel(description = "An iBeacon device represents an Apple conform iBeacon announcing its presence via Bluetooth advertising packets. ")
...
public class IBeaconDevice extends Device {
  ...
  public IBeaconDevice proximityUUID(String proximityUUID) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The UUID of the beacon, the purpose is to distinguish iBeacons in your network, from all other beacons in networks outside your control. ")
  ...
  public IBeaconDevice major(Integer major) {
    this.major = major;
    return this;
  }
   ...
   * @return major
  **/
  @ApiModelProperty(required = true, value = "Major values are intended to identify and distinguish a group. ")
  ...
  public IBeaconDevice minor(Integer minor) {
    this.minor = minor;
    return this;
  }
   ...
   * @return minor
  **/
  @ApiModelProperty(required = true, value = "Minor values are intended to identify and distinguish an individual. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IBeaconDevice ibeaconDevice = (IBeaconDevice) o;
    return Objects.equals(this.proximityUUID, ibeaconDevice.proximityUUID) &&
        Objects.equals(this.major, ibeaconDevice.major) &&
        Objects.equals(this.minor, ibeaconDevice.minor) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(proximityUUID, major, minor, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    proximityUUID: ").append(toIndentedString(proximityUUID)).append("\n");
