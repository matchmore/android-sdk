 ...
 */
@ApiModel(description = "A mobile device is one that potentially moves together with its user and therefore has a geographical location associated with it. ")
...
public class MobileDevice extends Device {
  ...
  public MobileDevice platform(String platform) {
   ...
   * @return platform
  **/
  @ApiModelProperty(required = true, value = "The platform of the device, this can be any string representing the platform type, for instance 'iOS'. ")
  ...
  public MobileDevice deviceToken(String deviceToken) {
   ...
   * @return deviceToken
  **/
  @ApiModelProperty(required = true, value = "The deviceToken is the device push notification token given to this device by the OS, either iOS or Android for identifying the device with push notification services. ")
  ...
  public MobileDevice location(Location location) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.platform, mobileDevice.platform) &&
        Objects.equals(this.deviceToken, mobileDevice.deviceToken) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(platform, deviceToken, location, super.hashCode());
  }
