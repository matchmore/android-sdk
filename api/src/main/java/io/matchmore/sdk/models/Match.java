 ...
 */
@ApiModel(description = "An object representing a match between a subscription and a publication.")
...
public class Match {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The id (UUID) of the match.")
  public String getId() {
    return id;
  }
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The timestamp of the match in seconds since Jan 01 1970 (UTC).")
  public Long getCreatedAt() {
    return createdAt;
  }

  public Match publication(Publication publication) {
  ...
  **/
  ...
  public Match subscription(Subscription subscription) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, match.id) &&
        ...
        Objects.equals(this.publication, match.publication) &&
        Objects.equals(this.subscription, match.subscription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, publication, subscription);
  }
