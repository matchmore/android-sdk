...
open class IBeaconTriple(
        /**
         * The deviceId of the beacon.
         */
        @SerializedName("deviceId")
        @get:ApiModelProperty(value = "The deviceId of the beacon. ")
        ...
        @get:ApiModelProperty(value = "The UUID of the beacon, the purpose is to distinguish iBeacons in your network, from all other beacons in networks outside your control. ")
        ...
        @get:ApiModelProperty(value = "Major values are intended to identify and distinguish a group. ")
        var major: Int? = null,
